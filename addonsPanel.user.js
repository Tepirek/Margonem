...
(function() {
    ...
    let expowiska = {
        ...
        "Koboldy": {
            map: "Nithal, Podgrodzie Nithal, Nizina Wieśniaków, Lazurytowa Grota p.1, Lazurytowa Grota p.2, Lazurytowa Grota p.3, Lazurytowa Grota p.4, Lazurytowa Grota p.3, Lazurytowa Grota p.2",
